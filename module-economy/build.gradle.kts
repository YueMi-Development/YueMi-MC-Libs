...
tasks.jar {
    archiveBaseName.set("$pluginName-economy")
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            artifactId = "$pluginName-economy"

            pom {
                name.set("$pluginName-economy")
                description.set("Economy module API for $pluginName (PaperMC)")
                url.set(repoUrl)
