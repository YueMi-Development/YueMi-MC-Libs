...
dependencies {
    // No extra project dependencies needed for module-event
}
...
tasks.jar {
    archiveBaseName.set("$pluginName-event")
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            artifactId = "$pluginName-event"

            pom {
                name.set("$pluginName-event")
                description.set("Event module API for $pluginName (PaperMC)")
                url.set(repoUrl)
